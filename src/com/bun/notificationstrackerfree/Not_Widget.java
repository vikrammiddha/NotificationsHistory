...
public class Not_Widget extends AppWidgetProvider{
	...
	private void showPurchaseMessage(Context context){
		...
		alertDialog2.setMessage("This feature is available in Pro version. Buy this app to enjoy Graphs.");
